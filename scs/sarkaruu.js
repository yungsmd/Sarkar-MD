...
const { delay, loading, react } = require("../bandaheali/utils");
...
// bug database
const { bugtext1 } = require("../bandaheali/bugs/bugtext1");
const { bugtext2 } = require("../bandaheali/bugs/bugtext2");
const { bugtext3 } = require("../bandaheali/bugs/bugtext3");
const { bugtext4 } = require("../bandaheali/bugs/bugtext4");
const { bugtext5 } = require("../bandaheali/bugs/bugtext5");
const { bugtext6 } = require("../bandaheali/bugs/bugtext6");
const { bugpdf } = require("../bandaheali/bugs/bugpdf.js");
