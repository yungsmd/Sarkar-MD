...
const { getBuffer } = require("../bandaheali/dl/Function");
...
marees({ nomCom: 'uptime',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*Sarkar-MD speed is: ${runtime(process.uptime())}_*`) 
...
let res = await getBuffer(linkkk);
   let caption = '*Powered by Sarkar-MD*' 
