...
marees({
  ...
  try {
    if (!_0x885e30 || _0x885e30.length === 0) {
      return _0x2b1a81("Please insert the image url Sarkar-Md will extract it for you.");
    }
    const _0x30bcaa = _0x885e30.join(" ");
...
marees({
  ...
  try {
    if (!_0x885e30 || _0x885e30.length === 0) {
      return _0x2b1a81("Please describe your image and Sarkar Md will generate it.");
    }
    const _0x30bcaa = _0x885e30.join(" ");
...
marees({
  ...
  try {
    if (!_0x885e30 || _0x885e30.length === 0) {
      return _0x2b1a81("Please describe your image  Sarkar md will generate it.");
    }
    const _0x30bcaa = _0x885e30.join(" ");
