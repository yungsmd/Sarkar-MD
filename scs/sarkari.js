...
marees({
  ...
  try {
    ...
    let imdbInfo = "Tap on the link to join movie channel on telegram and download movies there : https://t.me/bandahealitechai\n";
    imdbInfo += " ``` Sarkar MD FILMS```\n";
    imdbInfo += "*Made by Sarkar bandaheali*\n";
    imdbInfo += "🎬Title    : " + imdbData.Title + "\n";
    imdbInfo += "📅year      : " + imdbData.Year + "\n";
    imdbInfo += "⭐Assessment : " + imdbData.Rated + "\n";
    imdbInfo += "📆Release    : " + imdbData.Released + "\n";
