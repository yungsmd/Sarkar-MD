...
marees({ nomCom: "tagall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "link", categorie: 'Group', reaction: "🙋" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "promote", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "demote", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
  let { repondre, msgRepondu, infosGroupe, auteurMsgRepondu, verifGroupe, auteurMessage, superUser, idBot } = commandeOptions;
  let membresGroupe = verifGroupe ? await infosGroupe.participants : ""
  if (!verifGroupe) { return repondre("For groups only"); }
...
/** ***fin démettre****  **/
/** **retirer** */
marees({ nomCom: "remove", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "del", categorie: 'Group',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "info", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
 ...
 marees({ nomCom: "antilink", categorie: 'Group', reaction: "🚫" }, async (dest, zk, commandeOptions) => {
 ...
 marees({ nomCom: "antibot", categorie: 'Group', reaction: "😬" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "group", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "left", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "gname", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "gdesc", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "gpp", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
/////////////
marees({nomCom:"hidetag",categorie:'Group',reaction:"🎤"},async(dest,zk,commandeOptions)=>{
...
marees({ nomCom: "apk", reaction: "✨", categorie: "Recherche" }, async (dest, zk, commandeOptions) => {
