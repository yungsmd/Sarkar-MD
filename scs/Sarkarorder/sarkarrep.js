...
const searchRepo = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    ...
    https://api.github.com/repos/Sarkar-Bandaheali
...
const handleRepoCommand = async (m, Matrix, repoUrl) => {
  try {
    ...
    const messageText = `*_Sarkar-MD GITHUB INFORMATION_*\n
*_Name:_* ${name}
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            header: proto.Message.InteractiveMessage.Header.create({
              ...(await prepareWAMessageMedia({
                image: {
                  url: 'https://files.catbox.moe/p3ooer.jpeg',
                },
              ...
              buttons: [
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'i dont have any youtube channel',
                  }),
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://github.com/sarKarji1/Sarkar-MD/',
                  }),
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'whatsapp channel he nahi hai ab kia kren',
                  }),
                },
              ],
            }),
