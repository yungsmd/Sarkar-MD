...
const sleep =  (ms) =>{
  ...
  marees({ nomCom: "tgs", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
marees({ nomCom: "save", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
